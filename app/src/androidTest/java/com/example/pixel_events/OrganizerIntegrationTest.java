...
public class OrganizerIntegrationTest {
    ...
    public void testBitmapToBaseURL() {
        String base64 = EventActivity.bitmapToBase64(TEST_BITMAP);
    ...
    public void testBase64ToBitmap() {
        String base64 = EventActivity.bitmapToBase64(TEST_BITMAP);
        Bitmap test_bitmap = EventActivity.base64ToBitmap(base64);
    ...
    public void testImageUploadAndModify() throws InterruptedException {
        ...
        TEST_IMAGE_URL = EventActivity.bitmapToBase64(TEST_BITMAP);
        ...
        String updatedImageUrl = EventActivity.bitmapToBase64(TEST_BITMAP);
