 ...
 * AdminActivity
 *
 * Main activity for administrator users.
 * Provides navigation to browse events, profiles, images, and notification logs.
 * Hosts admin-specific fragments in a bottom navigation layout.
 *
 * Implements:
 * - US 03.04.01 (Browse events)
 * - US 03.05.01 (Browse profiles)
 * - US 03.06.01 (Browse images)
 * - US 03.08.01 (Access notification logs)
 *
 * Collaborators:
 * - AdminEventFragment, AdminProfileFragment, AdminImageFragment
 * - AdminNotificationLogFragment
 * - DatabaseHandler: Data access
 */
