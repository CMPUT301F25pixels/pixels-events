 ...
 * AuthManager
 *
 * Singleton class managing user authentication and session state.
 * Wraps Firebase Authentication and maintains current user profile in memory.
 * Provides device-based authentication eliminating password requirements.
 * Persists login state across app restarts.
 *
 * Implements:
 * - US 01.07.01 (Device-based identification)
 * - Session management for all user roles (entrant, organizer, admin)
 *
 * Collaborators:
 * - FirebaseAuth: Authentication backend
 * - Profile: Current user data
 * - DatabaseHandler: Profile retrieval
 */
