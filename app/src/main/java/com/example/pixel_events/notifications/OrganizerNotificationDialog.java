...
/**
 * Dialog for organizers to send notifications to entrants
 * US 02.07.01 - Send to all waitlist
 * US 02.07.02 - Send to selected entrants
 * US 02.07.03 - Send to cancelled entrants
 */
