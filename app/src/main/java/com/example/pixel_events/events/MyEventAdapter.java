 ...
 * MyEventAdapter
 *
 * RecyclerView adapter for displaying organizer's created events.
 * Shows event cards with delete and detail navigation options.
 * Displays waiting list status and event dates.
 *
 * Collaborators:
 * - Event: Displayed event data
 * - MyEventFragment: Parent fragment
 * - ImageConversion: Poster display
 */
