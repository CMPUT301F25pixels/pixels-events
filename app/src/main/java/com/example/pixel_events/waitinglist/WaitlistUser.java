 ...
 * WaitlistUser
 *
 * Model class representing an individual entrant within a WaitingList.
 * Tracks the user's lottery status throughout the registration lifecycle.
 * Status values: 0 (Waiting), 1 (Selected/Invited), 2 (Accepted), 3 (Declined/Cancelled).
 *
 * Implements:
 * - US 01.05.02 (Accept invitation)
 * - US 01.05.03 (Decline invitation)
 * - US 02.05.03 (Replacement draws when declined)
 * - US 02.06.04 (Cancel entrants)
 *
 * Collaborators:
 * - WaitingList: Parent container for all entrants
 * - Profile: User information
 * - DatabaseHandler: Status updates persistence
 */
